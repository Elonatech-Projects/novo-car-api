// src\app\(site)\available-cars\data\fallback-cars.ts
type Car = {
  _id: string;
  category: string;
  name: string;
...
export const cars: Car[] = [
  ...
  },
  {
    ...
    description: 'Spacious van for groups and event transportation.',
    features: [
      '2015 Standard High Roof',
      '14 seats',
      'Ample luggage space',
      'Comfortable for long trips',
    ],
    images: [
      'https://res.cloudinary.com/djogptxxc/image/upload/v1755183749/Hiace-High-roof-with-driver_ux4s7m.jpg',
      'https://res.cloudinary.com/djogptxxc/image/upload/v1755184354/Hiace-High-roof-interior_ggdepm.jpg',
    ],
    price: 174000,
  },
  {
    ...
    description: 'Enhanced performance and safety with advanced infotainment.',
    features: [
